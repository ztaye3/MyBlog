...
class AdminCv extends Component {
    ...
    editCategory = data => {
        this.props.personalAction(data, UPDATE_PROJECT, MANAGE_PROJECT_FRONTEND_URL)
    }

    deleteCategory = data => {
       this.props.personalAction(data, DELETE_PROJECT, MANAGE_PROJECT_FRONTEND_URL)
    }

    componentDidMount() {
        this.props.personalAction(null, GET_PROJECT, MANAGE_PROJECT_FRONTEND_URL)
    }

    render() {
        const { classes } = this.props;
        const data = this.props.personal.project;
        const { t } = this.props;
            ...
            <div>
                ...
                <Grid container justify="flex-end">
                     <Button
                      ...
                      href={ADD_PROJECT_FRONTEND_URL}
                    >
                         {t("personal.project.addProject")}
                    </Button>
                </Grid>
                ...
                <div style={{ maxWidth: "100%"}}>
                    ...
                    <MaterialTable
                         ...
                         options={{
                          ...
                          title={t("personal.project.manageProject")}
                          columns={
                              [

                                { title: 'Id', field: 'id', type: 'numeric', editable: 'never' },
                                { title: t("personal.cv.name"), field: 'name' },
                                  { title: t("personal.about.content"), field: 'summary' },
...
export default connect(mapStateToProps, {addUserAction, personalAction})(withTranslation()(withStyles(styles) (withRouter(AdminCv))));
