...
class AdminCv extends Component {
    ...
    editCategory = data => {
        this.props.personalAction(data, UPDATE_CV, MANAGE_CV_FRONTEND_URL)
    }

    deleteCategory = data => {
       this.props.personalAction(data, DELETE_CV, MANAGE_CV_FRONTEND_URL)
    }

    componentDidMount() {
        this.props.personalAction(null, GET_CV, MANAGE_CV_FRONTEND_URL)
    }

    render() {
        const { classes } = this.props;
        const data = this.props.personal.cv;
        const { t } = this.props;
