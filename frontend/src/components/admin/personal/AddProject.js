...
class AddCv extends Component {
    ...
    onAddAbout = () => {
           ...
           const userInput = {
                                    ...
                                    this.props.personalAction(userInput, ADD_PROJECT, MANAGE_PROJECT_FRONTEND_URL);
                    ...
                    >
                      <Grid className={classes.paper}>
                        ...
                        <Typography component="h1" variant="h5">
                            {t("personal.project.manageProject")}
                        </Typography>
                        <form className={classes.form} noValidate>
                            ...
                            <TextField
                                ...
                                fullWidth
                                id="summary"
                                label={t("personal.project.summary")}
                                name="summary"
                                autoComplete="project_summary"
                                onChange={this.onChange}
                            ...
                            <input
                                        ...
                                        <label htmlFor="contained-button-file">
                                            <Typography color={"textSecondary"}>{t("personal.cv.file")}</Typography>
