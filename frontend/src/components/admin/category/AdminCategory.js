...
import {
    ADD_POST_CATEGORY_URL,
    DELETE_POST_CATEGORY, GET_POST_CATEGORY,
...
class AdminCategory extends Component {
    ...
    editCategory = data => {
        this.props.postCategoryAction(data, UPDATE_POST_CATEGORY, MANAGE_POST_CATEGORY_URL)
    }

    deleteCategory = data => {
       this.props.postCategoryAction(data, DELETE_POST_CATEGORY, MANAGE_POST_CATEGORY_URL)
    }

    componentDidMount() {
        this.props.postCategoryAction(null, GET_POST_CATEGORY, MANAGE_POST_CATEGORY_URL)
    }

    render() {
        const { classes } = this.props;
        const data = this.props.postCategory.postCategory;
        const { t } = this.props;
                         ...
                         options={{
                          ...
                          columns={
                              [
                                ...
                                { title: t("postCategory.name"), field: 'name' },
                          ]
                          }
                          data={data}
                          editable={{
...
export default connect(mapStateToProps, {addUserAction, postCategoryAction})(withTranslation()(withStyles(styles) (withRouter(AdminCategory))));
